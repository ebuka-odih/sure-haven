    ...
    <footer id="contact" className="pt-20 pb-10 px-4 bg-[#050705]">
      <div className="max-w-7xl mx-auto border-t border-white/5 pt-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            <h3 className="text-xl font-bold tracking-wider uppercase text-emerald-600">Contact Us</h3>
            <div className="space-y-4 text-gray-300">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 glass rounded-full flex items-center justify-center border-emerald-900/30">
              ...
              <div className="flex items-center gap-4">
                ...
                <span>Okpanam Rd, Asaba Delta</span>
              </div>
            </div>
          </div>

          <div className="space-y-6">
            <h3 className="text-xl font-bold tracking-wider uppercase text-emerald-600">Follow Our Journey</h3>
            <div className="flex gap-4">
              <a href="https://instagram.com/surehavenltd" target="_blank" rel="noopener noreferrer" className="w-12 h-12 glass rounded-2xl flex items-center justify-center hover:bg-emerald-700 hover:text-white transition-all border-white/5">
              ...
              <a href="https://wa.me/2349037847206" target="_blank" rel="noopener noreferrer" className="w-12 h-12 glass rounded-2xl flex items-center justify-center hover:bg-emerald-700 hover:text-white transition-all border-white/5">
