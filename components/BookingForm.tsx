...
*Message:* ${formData.message}`;
  ...
  const inputStyles = "w-full bg-white/5 border border-white/10 rounded-xl px-5 py-3 focus:outline-none focus:border-emerald-600 transition-colors placeholder:text-gray-600 text-gray-200";
  ...
  return (
    <form onSubmit={handleSubmit} className="glass p-8 md:p-12 rounded-[2.5rem] space-y-6 shadow-2xl relative overflow-hidden">
      ...
      <button 
        type="submit" 
        className="w-full bg-emerald-700 text-white font-bold py-4 rounded-xl hover:bg-emerald-600 transition-all flex items-center justify-center gap-2 text-lg uppercase tracking-widest shadow-lg shadow-emerald-950/40"
      >
