    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-4 py-4">
      <div className="max-w-7xl mx-auto glass rounded-2xl px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-semibold tracking-wider uppercase text-gray-400">
          <a href="#hero" className="hover:text-[#ffebd7] transition-colors">Home</a>
          <a href="#portfolio" className="hover:text-[#ffebd7] transition-colors">Portfolio</a>
          <a href="#booking" className="hover:text-[#ffebd7] transition-colors">Booking</a>
          <a href="#contact" className="hover:text-[#ffebd7] transition-colors">Contact</a>
        </div>

        <a 
          href="#booking" 
          className="bg-[#ffddb2] text-black px-6 py-2 rounded-full font-bold hover:bg-[#ffddb2]/90 transition-all text-sm uppercase"
        >
          Work With Us
        </a>
      </div>
