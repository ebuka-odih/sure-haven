    ...
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative z-10 text-center max-w-4xl glass-dark p-8 md:p-16 rounded-[2rem] border-white/10">
        <div className="mb-6 flex justify-center">
            <svg className="w-20 h-20 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
            </svg>
        </div>
        <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6 leading-tight">
          SURE HAVEN <br />
          <span className="text-emerald-500">INTERIOR DESIGN</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a href="https://wa.me/2349037847206" target="_blank" rel="noopener noreferrer" className="px-10 py-4 border border-emerald-900/40 glass hover:bg-white/10 rounded-full font-bold transition-all uppercase tracking-widest">
            Chat on WhatsApp
          </a>
        </div>
      </div>
